/*********************************************************************************
*                              Author: Alexy Heitz                               *
*                File Name: /CPP-01/ex03/utilities/manageLines.cpp               *
*                    Creation Date: January 10, 2025 03:57 PM                    *
*                    Last Updated: January 18, 2025 17:40 PM                     *
*                              Source Language: cpp                              *
*                                                                                *
*                            --- Code Description ---                            *
...
std::string	getInputLine(void) {
	...
	if (std::cin.eof()) {
		...
		std::cout << ERROR << "Violence refuses to carry signals! The field is therefore initiated into the void!" << RESET << std::endl;
		sleep(COOLDOWN), erasePreviousLines(2), input = "";
	}
	else
